...
#include "../include/divideandwrite.hpp"
...
int main()
{
    ...
    string filename = "muxoutfaultnodes.txt";

    faultsVector = ReadUniqueIntegersFromFile(filename);
    // vector<int> faultnodes = {45, 123, 34, 90, 200};
    //  vector<int>::iterator it = faultnodes.begin();
    for (size_t i = 0; i < faultsVector.size(); i++)
    {
        ...
        // cout << endl
        //      << endl
        //      << "Do you wish to enter a new fault? : ";
        // cin >> ans;
    ...
    const string outputtestvec = "mux32outvec.txt";
